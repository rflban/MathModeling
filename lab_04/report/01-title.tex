\begin{titlepage}
    ...
    {\LARGE\scshape\bfseries
        Лабораторная работа \textnumero4
    }
    ...
    \begin{flushleft}
        ...
        \textbf{Тема} &
        \multicolumn{2}{l}{\uline{\quad{}Программно-алгоритмическая реализация\quad\hfill}}
                    \\&
        \multicolumn{2}{l}{\uline{\quad{}моделей на основе дифференциальных\quad\hfill}}
                    \\&
        \multicolumn{2}{l}{\uline{\quad{}уравнений в частных производных\quad\hfill}}
                    \\&
        \multicolumn{2}{l}{\uline{\quad{}с краевыми условиями II и III рода\quad\hfill}}
        \\
    \end{tabular}
    \end{flushleft}
    \par
