\begin{titlepage}
    ...
    {\LARGE\scshape\bfseries
        Лабораторная работа \textnumero2
    }
    ...
    \begin{flushleft}
        ...
        \textbf{Тема} & \multicolumn{2}{l}{\uline{\quad{}Программно-алгоритмическая реализаци\quad\hfill}}
                    \\&
        \multicolumn{2}{l}{\uline{\quad{}методов Рунге-Кутта 2-го и 4-го порядков\quad\hfill}}
                    \\&
        \multicolumn{2}{l}{\uline{\quad{}точности при решении системы ОДУ\quad\hfill}}
                    \\&
        \multicolumn{2}{l}{\uline{\quad{}в задаче Коши\quad\hfill}}
        \\
    \end{tabular}
    \end{flushleft}
    \par
